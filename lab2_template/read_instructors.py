...
print(
    "4. Find all full time instructors with First Name starts with `Y` and learners count greater "
    "than 30000",
)
...
print(
    "5. Find all full time instructors with First Name starts with `Y` "
